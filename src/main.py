...
LIMITE_TEMPO_X = 5000       # ms -> tempo maximo de porta aberta
LIMITE_VARIACAO_Y = 3.0     # graus C -> variacao termica tolerada
...
def loop():
    ...
    if (alarme_porta or alarme_termico) and estado_porta_fechada and temperatura_ok:
        alarme_porta = False
        alarme_termico = False
        referencia_definida = False  
